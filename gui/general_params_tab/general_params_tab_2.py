...
def general_params_tab_2(frame):
    ...
    def axis_params(axis_name: str,  frame, axis_id: int, row: int):
        ...
        param_field(param_name='modbus_permission', row=axis_id+row, column=2, frame=frame, axis_id=axis_id, param_value=-1)
        param_field(param_name='driver_output_permission', row=axis_id+row, column=4, frame=frame, axis_id=axis_id, param_value=-1)
        param_field(param_name='weak_magnet_angle', row=axis_id+row, column=6, frame=frame, axis_id=axis_id, param_value=-1)
        param_field(param_name='speed_loop_scale_coefficient', row=axis_id+row, column=8, frame=frame, axis_id=axis_id, param_value=-1)
        param_field(param_name='speed_loop_integration_time', row=axis_id+row, column=10, frame=frame, axis_id=axis_id, param_value=-1)
        param_field(param_name='position_loop_scale_coefficient', row=axis_id+row, column=12, frame=frame, axis_id=axis_id, param_value=-1)
