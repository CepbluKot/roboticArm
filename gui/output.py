...
def init_gui(interpolation_call: typing.Callable, get_axis_target_pos_value_funcs_dict: typing.Dict, set_speed_call: typing.Callable, set_accel_call: typing.Callable, set_sync_call: typing.Callable, get_speed_call: typing.Callable, get_accel_call: typing.Callable, get_sync_call: typing.Callable, save_settings_calls: typing.Callable, set_zero_pos_calls: typing.Dict, points_ride_call: typing.Callable[[Treeview], None]):
    window = Tk()
    ...
    controls_tab(tab1, interpolation_call, get_axis_target_pos_value_funcs_dict, set_speed_call, set_accel_call, set_sync_call, get_speed_call, get_accel_call, get_sync_call)
