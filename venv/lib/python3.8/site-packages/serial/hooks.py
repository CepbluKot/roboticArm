...
class Hooks(object):
    ...
    def __deepcopy__(self, memo=None):
        ...
        return self.__class__(
            **{k: deepcopy(v, memo=memo) for k, v in vars(self).items()}
        )
    ...
    if isinstance(model_instance, type):
        ...
        if model_instance._hooks is None:
            ...
            model_instance._hooks = (
                Object()
                if issubclass(model_instance, serial.model.Object)
                else Array()
                if issubclass(model_instance, serial.model.Array)
                else Dictionary()
...
def write(
    ...
    if not isinstance(meta, mt):
        raise ValueError(
            ...
            % (qualified_name(t), qualified_name(mt))
        )
