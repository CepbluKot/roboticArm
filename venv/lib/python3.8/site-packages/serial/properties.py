...
try:
    ...
    Union = (
        ...
        Sequence
    ) = Callable = Dict = Any = Hashable = Collection = Tuple = Iterable = None
...
class Null(
    object
):  # noqa - inheriting from object is intentional, as this is needed for python 2x compatibility
    """
...
def _validate_type_or_property(type_or_property):
    ...
    if not (
        ...
        or isinstance(type_or_property, Property)
    ):
        raise TypeError(type_or_property)
...
class Types(list):
    ...
    def __init__(
        ...
        if not isinstance(property_, Property):
            raise TypeError(
                "The parameter `property` must be a `type`, or an instance of `%s`."
    ...
    def __deepcopy__(self, memo=None):
        ...
        return self.__class__(
            self.property_, tuple(deepcopy(v, memo=memo) for v in self)
        )
...
class Property(object):
    ...
    def unmarshal(self, data):
        ...
        if (
            isinstance(data, collections_abc.Iterable)
            and not isinstance(data, (str, bytes, bytearray, native_str))
            and not isinstance(data, abc.model.Model)
        ):
    ...
    def marshal(self, data):
        # type: (Any) -> Any
        return serial.marshal.marshal(
            data, types=self.types
        )  # , types=self.types, value_types=self.value_types)
    ...
    def __repr__(self):
        ...
        for p, v in properties_values(self):
            ...
            if (v is not None) and (v is not NULL):
                if isinstance(v, collections_abc.Sequence) and not isinstance(
                    v, (str, bytes)
                ):
                    rvs = ["("]
                    for i in v:
...
class String(Property):
    ...
    def __init__(
        ...
        super().__init__(types=(str,), name=name, required=required, versions=versions)
...
class Date(Property):
    ...
    def __init__(
        ...
        super().__init__(types=(date,), name=name, required=required, versions=versions)
...
class DateTime(Property):
    ...
    def __init__(
        ...
        super().__init__(
            types=(datetime,), name=name, required=required, versions=versions
        )
...
class Bytes(Property):
    ...
    def __init__(
        ...
        super().__init__(
            types=(bytes, bytearray), name=name, required=required, versions=versions
        )
...
class Enumerated(Property):
    ...
    def __init__(
        ...
        super().__init__(types=types, name=name, required=required, versions=versions)
    ...
    def values(self, values):
        ...
        if not ((values is None) or callable(values)):
            ...
            if (values is not None) and (
                not isinstance(values, (collections_abc.Sequence, collections_abc.Set))
            ):
                raise TypeError(
...
class Number(Property):
    ...
    def __init__(
        ...
        # type: (...) -> None
        super().__init__(
            types=(numbers.Number,), name=name, required=required, versions=versions
        )
...
class Integer(Property):
    ...
    def __init__(
        ...
        super().__init__(types=(int,), name=name, required=required, versions=versions)
...
class Boolean(Property):
    ...
    def __init__(
        ...
        # type: (...) -> None
        super().__init__(types=(bool,), name=name, required=required, versions=versions)
...
class Array(Property):
    ...
    def __init__(
        ...
        super().__init__(
            types=(serial.model.Array,), name=name, required=required, versions=versions
        )

    def unmarshal(self, data):
        # type: (Any) -> Any
        return serial.marshal.unmarshal(
            data, types=self.types, item_types=self.item_types
        )
...
class Dictionary(Property):
    ...
    def unmarshal(self, data):
        # type: (Any) -> Any
        return serial.marshal.unmarshal(
            data, types=self.types, value_types=self.value_types
        )
