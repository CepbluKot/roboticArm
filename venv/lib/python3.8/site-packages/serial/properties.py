...
class String(Property):
    ...
    def __init__(
        ...
        super().__init__(
            types=(str,), name=name, required=required, versions=versions,
        )
...
class Date(Property):
    ...
    def __init__(
        ...
        super().__init__(
            types=(date,), name=name, required=required, versions=versions,
        )
...
class Integer(Property):
    ...
    def __init__(
        ...
        super().__init__(
            types=(int,), name=name, required=required, versions=versions,
        )
...
class Boolean(Property):
    ...
    def __init__(
        ...
        # type: (...) -> None
        super().__init__(
            types=(bool,), name=name, required=required, versions=versions,
        )
