...
USB_ID_VENDOR = (
    0x04D8
)  # This is Microchip's vendor ID, presumably licensed as Canalyst-II uses a PIC32
...
SEND_TYPE_ECHO = (
    2
)  # Echo the message back as RX (note: the TX message is echoed even if sending fails!!)
...
class MessageBuffer(LittleEndianStructure):
    ...
    _pack_ = 1
    _fields_ = [("count", c_byte), ("messages", Message * 3)]
