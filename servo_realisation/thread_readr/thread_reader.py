            ...
            if one_recieved_command.decoded_data != 'success' and one_recieved_command.decoded_data != 'fail':
                ...
                if one_recieved_command.servo_id in servo_info_storage:
                    ...
                    if one_recieved_command.command_data in servo_info_storage[one_recieved_command.servo_id].commands_info_storage:
                        ...
                        print('read oopdet', one_recieved_command.command_data, servo_info_storage[one_recieved_command.servo_id].commands_info_storage[one_recieved_command.command_data].value_link, servo_info_storage[one_recieved_command.servo_id].commands_info_storage[one_recieved_command.command_data].is_new_value)
