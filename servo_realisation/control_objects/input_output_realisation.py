...
def create_servo_object(servo_id):
    servo = servo_realisation.control_objects.servo.Servo(device_object=device, servo_id=servo_id)
    servo_abs = servo_realisation.control_objects.servo_abstraction.ServoAbstraction(servo)
    return servo_abs
