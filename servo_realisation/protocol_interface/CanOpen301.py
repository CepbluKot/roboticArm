...
class CanOpen301(ProtocolInterface):
    ...
    __enable_output_command_full = 26010010
    ...
    def __init__(
        ...
        self.__enable_output_command_short = self.__get_short_command(self.__enable_output_command_full)
    ...
    def send_target_pos(self, servo_id: int, value: int) -> canalystii.Message:
        ...
        # print("send target_pos --> ", servo_id)
    ...
    def send_enable_output(self, servo_id: int) -> canalystii.Message:
        command_code_from_documentation = self.__enable_output_command_full
        address = self.__SDO_object
        is_read = False
