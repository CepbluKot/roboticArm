...
servo_1_constructor = servo_realisation.commands_constructor.input_output_realisation.create_servo_command_constructor(
    servo_object=servo_1
)

servo_2_constructor = servo_realisation.commands_constructor.input_output_realisation.create_servo_command_constructor(
    servo_object=servo_2
)
servo_3_constructor = servo_realisation.commands_constructor.input_output_realisation.create_servo_command_constructor(
    servo_object=servo_2
)
servo_4_constructor = servo_realisation.commands_constructor.input_output_realisation.create_servo_command_constructor(
    servo_object=servo_4
)
servo_5_constructor = servo_realisation.commands_constructor.input_output_realisation.create_servo_command_constructor(
...
def servo_move_to_pos_sync(servo_constructor: servo_realisation.commands_constructor.commands_constructor_interface.CommandConstructorInterface, servo_object: servo_realisation.control_objects.servo_interface.ServoInterface, target_time: int, target_pos: int):
    servo_get_pos_command = servo_constructor.create_command(command_from_documentation='60640020', address=0x600)
...
def move_to_pos_sync(servo_1_target_pos=0, servo_2_target_pos=0, servo_3_target_pos=0, servo_4_target_pos=0, servo_5_target_pos=0, servo_6_target_pos=0):
    ...
    print(servo_2_distance_delta, servo_1_distance_delta)

    if not servo_1_current_speed:
        servo_1_set_speed_command = servo_1_constructor.create_command(command_from_documentation='60810020', address=0x600, write_value=20)
        servo_1.send(channel=0, messages=servo_1_set_speed_command)

    if not servo_2_current_speed:
        servo_2_set_speed_command = servo_2_constructor.create_command(command_from_documentation='60810020', address=0x600, write_value=20)
        servo_2.send(channel=0, messages=servo_2_set_speed_command)
    ...
    if abs(servo_1_distance_delta) > abs(servo_2_distance_delta):
        ...
        servo_2_set_speed_command = servo_2_constructor.create_command(command_from_documentation='60810020', address=0x600, write_value=servo_2_target_speed)
        servo_2.send(channel=0, messages=servo_2_set_speed_command)
        ...
        servo_1_set_speed_command = servo_1_constructor.create_command(command_from_documentation='60810020', address=0x600, write_value=servo_1_target_speed)
        servo_1.send(channel=0, messages=servo_1_set_speed_command)
    ...
    servo_1_set_pos_command = servo_1_constructor.create_command(command_from_documentation='60640020', address=0x500, write_value=32768*50/360*servo_1_target_pos)
    servo_2_set_pos_command = servo_2_constructor.create_command(command_from_documentation='60640020', address=0x500, write_value=32768*50/360*servo_2_target_pos)


    servo_1.send(channel=0, messages=servo_1_set_pos_command)
    servo_2.send(channel=0, messages=servo_2_set_pos_command)

    
    start_move_to_target_pos = servo_1_constructor.general_move_command()
